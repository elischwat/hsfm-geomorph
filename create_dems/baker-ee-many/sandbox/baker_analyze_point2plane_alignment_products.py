...
all_point2plane_dems = glob.glob("/data2/elilouis/timesift/baker-ee-many/mixed_timesift_manual_selection/individual_clouds/**/point2plane-trans_source-DEM.tif", recursive=True)
print(all_point2plane_dems)


for f in all_point2plane_dems:
