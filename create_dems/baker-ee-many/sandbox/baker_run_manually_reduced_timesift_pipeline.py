...
combined_metadata_file_path = '/data2/elilouis/timesift/baker-ee-many/combined_metashape_manual_selection.csv'
combined_image_metadata_file_path = '/data2/elilouis/timesift/baker-ee-many/combined_image_metadata_manual_selection.csv'
preprocessed_images_dir = '/data2/elilouis/timesift/baker-ee-many/preprocessed_images'
timesift_output_path = '/data2/elilouis/timesift/baker-ee-many/mixed_timesift_manual_selection'
